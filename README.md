...
| [Анализ вакансий в Linkedin](analysis_linkedin)| Я распарсила и выполнила предобработку данных открытых вакансий на позицию аналитик данных в Linkedin. Построила дашборд в разрезе ключевых характериктик (просмотр по ссылке https://datalens.yandex.ru/ui538detirbck-rynok-vakansiy-analitikov-v-evrope| *Python* *Pandas* *Math* *Datalens*|36
